...
public class BaseTest {
	...
	public void screenShot1(String ssname) {
		try {
			File source = ((TakesScreenshot) driver).getScreenshotAs(OutputType.FILE);

			File dest = new File("D:\\guvi automation testing\\screenshots\\videoPage.png");
...
/*BASETEST.Java
	...
	// javasscriptexecutor (scroll up, down, click, scrollintoView)
	// screenshot
